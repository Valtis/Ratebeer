...
describe "BeermappingApi" do
  ...
  it "When one entry is cached, it is parsed and returned" do
  ...
  it "When HTTP GET returns multiple entries, they ared parsed and returned" do
    ...
    expect(places[0].street).to eq("Kaivokatu 1")



    expect(places[5].name).to eq("Pikkulintu")
    expect(places[5].street).to eq("Klaavuntie 11")
